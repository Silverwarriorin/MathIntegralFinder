...
# Getting Bounds
    ...
    left_bound = int(input("Enter the left bound of the equation: "))
    right_bound = int(input("Enter the right bound of the equation: "))

# Checking Bounds

    if right_bound < left_bound:
        print("Left bound MUST be less than right bound!")
        main()
